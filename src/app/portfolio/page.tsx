      ...
      <div className="h-[40rem] w-full rounded-md bg-black-950 relative flex flex-col items-center justify-center antialiased">
        <div className="max-w-3xl mx-auto p-4">
          ...
          <p className="text-neutral-500 max-w-lg mt-6 mx-auto my-2 text-sm text-center relative z-10">
            At Logic Zephyr, we specialize in delivering cutting-edge solutions
            to empower businesses worldwide. Our innovative tools and services
            are designed to streamline your operations, enhance productivity,
            and drive success. Join us in shaping the future of technology.
          </p>
        </div>
        <BackgroundBeams />
      </div>
